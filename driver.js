...
Driver.prototype.devModeOn = function (callback) {
    ...
    this.setAntiDos(function (err, data) {
        ...
        ollie.setTXPowerCallback(7, function (err, data) {
...
// Set BLE transmit power. with callback for dev mode
Driver.prototype.setTXPowerCallback = function(level,callback) {
